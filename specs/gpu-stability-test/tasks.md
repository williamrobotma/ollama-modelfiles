...
The core-offset ladder that produced it: docs/history 2026-08-08 log, section 12.
...
- [ ] Safety: live-probe 11433 and abort; own-PID capture; unload only when `.status.value` says so
