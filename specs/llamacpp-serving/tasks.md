...
- [x] Re-verify #24795 status via api.github.com. Verified 2026-07-17 (adversarial re-check): still open, no fix merged through b10036; fix candidate PR #24942 unmerged. BUT the failure does NOT reproduce on-box on b9860 - 12B pair loads and drafts (acceptance 0.75-0.81), 26B pair loads (CPU test, acceptance 0.94); leading explanation is VRAM-pressure-dependent triggering (contributor comment on the issue + issue thread's mixed hardware reports). Classic-drafter alternative moot.
