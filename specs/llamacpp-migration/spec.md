...
3. Move Open WebUI over; the Qwen GGUFs that reject multi-system requests need a guard-free template (`--chat-template-file`, froggeric). The guard is the official Qwen default, not one build - unsloth Qwen3.5-9B non-MTP, OBLITERATUS-27B, Queen-27B, and Qwopus3.5-9B-coder. See `specs/done/chat-template-refresh` (executed 2026-07-23).
