...
- [x] Create `modelfiles/gemma4/12b-it-qat-mtp/Modelfile`
  ...
  - Verified via `ollama create` + `ollama show --parameters`: all seven inherited automatically through `FROM gemma4-12b-it-qat` (layered pattern), no manual copy needed.

- [x] Create `modelfiles/gemma4/31b-it-qat-mtp/Modelfile`
